...
return [
    ...
    'timestamp' => 1449026161,
    'checksum' => '25b96b231b51e2be13a998995b2445c3',
    'files' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.form.multiple' => [
                ...
                'name' => 'plugins.form.multiple'
            ],
            'plugins.form.desination' => [
                'type' => 'text',
                'label' => 'PLUGIN_FORM.DESTINATION',
                'help' => 'PLUGIN_FORM.DESTINATION_HELP',
                'default' => '@self',
                'name' => 'plugins.form.desination'
            ],
            'plugins.form.accept' => [
                'type' => 'selectize',
                'size' => 'large',
        ...
        'nested' => [
            'plugins' => [
                ...
                'form' => [
                    ...
                    'multiple' => 'plugins.form.multiple',
                    'desination' => 'plugins.form.desination',
                    'accept' => 'plugins.form.accept'
                ],
                'login' => [
